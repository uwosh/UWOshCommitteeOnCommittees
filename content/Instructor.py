...
Instructor_schema = getattr(Person, 'schema', Schema(())).copy() + \
    schema.copy()
...
class Instructor(Person):
    ...
    global_allow = 1
    #content_icon = 'Instructor.gif'
    immediate_view = 'base_view'
    default_view = 'base_view'
    suppl_views = ()
    typeDescription = "Instructor"
    typeDescMsgId = 'description_edit_instructor'
...
registerType(Instructor, PROJECTNAME)
